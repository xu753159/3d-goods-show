...
export default {
  ...
  data () {
    ...
    // htpropertytps://dotdev.co/peeking-into-vue-js-2-part-1-b457e60c88c6#.918arzkow
    let curObj = this.obj
     ...
     if(this.onRaycaster){
        obj.traverse((node)=> {
            if (node.isMesh) {
                ...
                node.onRaycaster=this.onRaycaster
              
            }
          });
     }
      obj.onRaycaster=this.onRaycaster
